...
<div class="modal fade bookingModal mw-booking" tabindex="-1" role="dialog" aria-labelledby="bookingModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="validation__newsletter" novalidate method="post" action="" enctype="multipart/form-data">
                    <div class="form-row">
                        ...
                        <div class="col-12 mb-15">
                            <div class="newsletter__textarea">
                        ...
                        <div class="col-12">
                            <div class="newsletter__button text-center">
                                <input type="submit" class="btn btn-sm btn-custom" name="submit__newsletter"
