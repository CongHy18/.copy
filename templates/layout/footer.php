<div class="footer">
    <div class="footer__article">
        <div class="wrap-content">
            <div class="row justify-content-between">
                <div class="footer__news col-sm-5 mgb-res">
                    <h2 class="footer__title line__bottom bold up">Thông tin liên hệ</h2>
                ...
                <div class="footer__news col-sm-3 mgb-res">
                    <h2 class="footer__title line__bottom bold up">Kết nối với chúng tôi</h2>
                    <ul class="footer__ul">
                ...
                <div class="footer__news col-sm-4">
    ...
    <div class="footer__powered">
        <div class="wrap-content">
            <div class="row">
                <div class="footer__copyright col-md-6">Copyright © <?=$setting['name'.$lang]?> All rights reserved. Designed by Nina</div>
                <div class="footer__statistic col-md-6">
