            ...
            function() {
                grecaptcha.ready(function() {
                    ...
                    <?php  if (isset($config['LQD']['booking']) && $config['LQD']['booking'] == true) { ?>
                        generateCaptcha('Newsletter', 'recaptchaResponseBooking');
                    <?php }?>
...
<script>
    var scriptMainData1 = <?= json_encode($addons->set('script-main', 'script-main', 0)); ?>;
    var scriptMainData2 = <?= json_encode($addons->get()); ?>;
