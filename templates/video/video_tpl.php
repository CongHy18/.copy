<div class="title-main"><span><?= @$titleMain ?></span><div class="animate-border m-auto"></div></div>
<div class="content-main form-row">
    <?php if (!empty($video)) {
        foreach ($video as $k => $v) { ?>
            <div class="video col-6 col-md-4 col-lg-3 col-xl-3" data-fancybox="video" data-src="https://www.youtube.com/watch?v=<?= $func->getYoutube($v['link_video']) ?>">
