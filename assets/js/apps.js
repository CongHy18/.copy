...
NN_FRAMEWORK.Pagings = function () {
	...
	$("select").on("change", function (e) {
		var idl = $(".prodl").data("list") ? $(".prodl").data("list"):0;
		var idc = $(".prodl1").data("cat") ? $(".prodl1").data("cat"):0;
		var idi = $(".prodl2").data("item") ? $(".prodl2").data("item"):0;
		var type = $(".type").data("type") ? $(".type").data("type"):'';
...
// 	  loadPaging("api/filter.php?perpage=20&" + formData, ".table-product");
// 	});
//   };
