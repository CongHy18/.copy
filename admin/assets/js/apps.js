  ...
  if ($(".form-control-ckeditor").length) {
    CKEDITOR.editorConfig = function (config) {
      ...
      config.contentsCss = [
        ...
        CONFIG_BASE + ADMIN + "/assets/fontawesome611/all.css",
        ASSET + "assets/css/fonts.css",
      ];
      config.font_names = FONTS_CKF + config.font_names;

      /* All Plugins */
      config.extraPlugins =
        "codemirror,texttransform,copyformatting,html5audio,flash,youtube,wordcount,tableresize,widget,lineutils,clipboard,dialog,dialogui,widgetselection,lineheight,video,videodetector,ckeditorfa" +
        image2;
      ...
      // if(PHP_VERSION>50000 && PHP_VERSION<70000){ config.filebrowserBrowseUrl = 'ckfinder3.4.1/ckfinder.html?token=' + TOKEN; config.filebrowserUploadUrl ='ckfinder3.4.1/core/connector/php/connector.php?command=QuickUpload&type=Files&token=' + TOKEN;}
