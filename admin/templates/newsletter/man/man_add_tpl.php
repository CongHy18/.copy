        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                ...
                <div class="form-group-category row">
                    ...
                    <?php } ?>
                    <?php if (isset($config['newsletter'][$type]['day']) && $config['newsletter'][$type]['day'] == true) { ?>
                        <div class="form-group col-md-4">
                            <label for="day">Thời gian:</label>
                            <input type="text" class="form-control text-sm" name="data[day]" id="day" placeholder="Thời gian" value="<?= (!empty($flash->has('day'))) ? $flash->get('day') : @$item['day'] ?>" required>
                        </div>
                    <?php } ?>
