                                        ...
                                        <div class="tab-pane fade show <?= ($k == 'vi') ? 'active' : '' ?>" id="tabs-lang-<?= $k ?>" role="tabpanel" aria-labelledby="tabs-lang">
                                            ...
                                            <?php if (isset($config['product'][$type]['size_product']) && $config['product'][$type]['size_product'] == true) { ?>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control for-seo text-sm" name="data[size_product]" id="size_product" placeholder="Kích thước" value="<?= (!empty($flash->has('size_product'))) ? $flash->get('size_product') : @$item['size_product'] ?>" >
                                                </div>
                                            <?php } ?>
