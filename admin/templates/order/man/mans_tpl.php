...
$linkPrint = "index.php?com=billAll&act=print";
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <?php } ?>
                        <?php if(
                            (isset($config['order']['bill']) && $config['order']['bill'] == true)
                        ) { ?>
                            <th class="align-middle">In hóa đơn</th>
                        <?php } ?>
                    ...
                    <tbody>
                        <?php for ($i = 0; $i < count($items); $i++) { ?>
                            <tr>
                                ...
                                <?php } ?>
                                <?php if(isset($config['order']['bill']) && $config['order']['bill'] == true) { ?>
                                    <td class="align-middle text-center text-lg text-nowrap">
                                        <a class="text-primary" target="_blank" href="index.php?com=bill&act=man&id=<?=$items[$i]['id']?>" title="In"><i class="fas fa-print"></i></a>
                                    </td>
                                 <?php } ?>
