        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <?php if (isset($config['setting']['time-open']) && $config['setting']['time-open'] == true) { ?>
                        <div class="form-group col-md-4 col-sm-6">
                            <label for="time-open">Giờ mở cửa:</label>
                            <input type="text" class="form-control text-sm" name="data[options][time-open]" id="time-open" placeholder="Giờ mở cửa" value="<?= (!empty($flash->has('time-open'))) ? $flash->get('time-open') : @$options['time-open'] ?>" required>
                        </div>
                    <?php } ?>
